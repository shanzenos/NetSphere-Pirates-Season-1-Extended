...
{
    internal sealed class RaceGameRule : GameRuleBase
    {
        private static readonly TimeSpan TouchdownWaitTime = TimeSpan.FromSeconds(12);

        private readonly RacetouchdownAssistHelper _RacetouchdownAssistHelper = new RacetouchdownAssistHelper();
        ...
        {
            return new RacePlayerRecord(plr);
        }
        ...
        public void OnScoreRebound(Player newPlr, Player oldPlr)
        {
            ...
            if (oldPlr != null)
                _RacetouchdownAssistHelper.Update(oldPlr);
        ...
        public void OnScoreGoal(Player plr)
        {
            ...
            Player assist = null;
            if (_RacetouchdownAssistHelper.IsAssist(plr))
            {
                assist = _RacetouchdownAssistHelper.LastPlayer;
        ...
        private static RacePlayerRecord GetRecord(Player plr)
        {
            return (RacePlayerRecord)plr.RoomInfo.Stats;
        }
    }

    internal class RacePlayerRecord : PlayerRecord
    {
        ...
        public RacePlayerRecord(Player plr)
            : base(plr)
        { }
    ...
    internal class RacetouchdownAssistHelper
    {
