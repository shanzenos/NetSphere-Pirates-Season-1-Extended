...
{
    internal sealed class OWOGameRule : GameRuleBase
    {
        private static readonly TimeSpan TouchdownWaitTime = TimeSpan.FromSeconds(12);

        private readonly OWOtouchdownAssistHelper _OWOtouchdownAssistHelper = new OWOtouchdownAssistHelper();
        ...
        {
            return new OWOPlayerRecord(plr);
        }
        ...
        public void OnScoreRebound(Player newPlr, Player oldPlr)
        {
            ...
            if (oldPlr != null)
                _OWOtouchdownAssistHelper.Update(oldPlr);
        ...
        public void OnScoreGoal(Player plr)
        {
            ...
            Player assist = null;
            if (_OWOtouchdownAssistHelper.IsAssist(plr))
            {
                assist = _OWOtouchdownAssistHelper.LastPlayer;
        ...
        private static OWOPlayerRecord GetRecord(Player plr)
        {
            return (OWOPlayerRecord)plr.RoomInfo.Stats;
        }
    }

    internal class OWOPlayerRecord : PlayerRecord
    {
        ...
        public OWOPlayerRecord(Player plr)
            : base(plr)
        { }
    ...
    internal class OWOtouchdownAssistHelper
    {
