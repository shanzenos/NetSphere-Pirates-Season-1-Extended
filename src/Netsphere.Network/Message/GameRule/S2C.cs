...
namespace Netsphere.Network.Message.GameRule
{
    ...
    public class SSlaughterAttackPointAckMessage: IGameRuleMessage
    {
        ...
        public SSlaughterAttackPointAckMessage() //used by chaser
        {

        }
        public SSlaughterAttackPointAckMessage(ulong accountId, float unk1, float unk2)
        {
            AccountId = accountId;
            Unk1 = unk1;
            Unk2 = unk2;
    ...
    public class SSlaughterHealPointAckMessage: IGameRuleMessage
    {
        ...
        public SSlaughterHealPointAckMessage() //used by chaser
        {

        }
        public SSlaughterHealPointAckMessage(ulong accountId, float unk)
        {
            AccountId = accountId;
            Unk = unk;
        }
    ...
    public class SCaptainLifeRoundSetUpAckMessage: IGameRuleMessage
    {
        ...
        public SCaptainLifeRoundSetUpAckMessage(CaptainLifeDto[] plrs) //used by chaser's hacky hp fix
        {
            Players = plrs;
        }
    }
